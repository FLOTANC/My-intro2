...
const defs: [string, number, string][] = [
  ['w1-1', 1, '2・3の段'], ['w1-2', 1, '4・5の段'], ['w1-3', 1, '6・7の段'],
  ['w1-4', 1, '8・9の段'], ['w1-5', 1, '九九ミックス'], ['w1-6', 1, '九九マスター'],
  ['w2-1', 2, '九九の逆算'], ['w2-2', 2, 'わり算の基本'], ['w2-3', 2, 'あまりのあるわり算'],
  ['w2-4', 2, 'あまりチャレンジ'], ['w2-5', 2, 'わり算ミックス'],
